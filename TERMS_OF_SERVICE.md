<!--
  EA Soft Minecraft Launcher — Terms of Service / Hizmet Koşulları
  English version first, Türkçe sürüm aşağıda.
-->

**Language / Dil:** [English](#terms-of-service) · [Türkçe](#hizmet-koşulları)
...
You agree **not** to use the Launcher to:

- Violate Mojang's or Microsoft's End User License Agreements or Terms of Use.
- Pirate, crack, or play Minecraft without a legitimate license where one is required.
- Distribute malware, cheats designed to harm other players, or content that is illegal in your jurisdiction.
- Attempt to gain unauthorized access to any account or service.

You are solely responsible for any mods, resource packs, or other content you choose to install through the Launcher.
...
The Launcher is provided **"as is" and "as available", without warranty of any kind**, express or implied, including but not limited to warranties of merchantability, fitness for a particular purpose, and non-infringement. We do not guarantee that the Launcher will be error-free, secure, or available at all times.
...
We may update these Terms from time to time. The "Last updated" date at the top shows when they were last changed. Continued use of the Launcher after changes means you accept the updated Terms.
...
Başlatıcı şu yöntemlerle giriş yapmanıza olanak tanır:

- **Microsoft hesapları** — Minecraft: Java Edition sahipliğinizi doğrulamak için Microsoft'un resmi OAuth giriş akışı üzerinden.
- **ely.by hesapları** — üçüncü taraf bir kimlik doğrulama hizmeti.
- **Çevrimdışı hesaplar** — yalnızca bir kullanıcı adı kullanır ve çevrimiçi kimlik doğrulaması sağlamaz.

Hesap bilgilerinizi güvende tutmaktan siz sorumlusunuz. Çevrimiçi ve resmi sunucularda oynamak için Minecraft: Java Edition'ın geçerli bir kopyasına sahip olmanız gerekir. Başlatıcı, herhangi bir kimlik doğrulamayı, lisans kontrolünü veya kopya korumasını atlatmaz, devre dışı bırakmaz veya kaldırmaz.

## 3. Kabul Edilebilir Kullanım

Başlatıcı'yı şu amaçlarla kullanmamayı kabul edersiniz:

- Mojang'ın veya Microsoft'un Son Kullanıcı Lisans Sözleşmelerini veya Kullanım Koşullarını ihlal etmek.
- Gerekli olan yerlerde geçerli bir lisans olmadan Minecraft'ı korsan kullanmak, kırmak veya oynamak.
- Kötü amaçlı yazılım, diğer oyunculara zarar vermek için tasarlanmış hileler veya bulunduğunuz yerde yasa dışı olan içerikler dağıtmak.
- Herhangi bir hesaba veya hizmete yetkisiz erişim sağlamaya çalışmak.

Başlatıcı aracılığıyla kurmayı seçtiğiniz tüm modlardan, kaynak paketlerinden veya diğer içeriklerden yalnızca siz sorumlusunuz.

## 4. Üçüncü Taraf İçerikler

Başlatıcı, Modrinth gibi üçüncü taraf kaynaklardan mod, shader ve kaynak paketi indirebilir; Microsoft ve ely.by üzerinden giriş yapabilir. Bu üçüncü taraf içerik veya hizmetlerin sahibi, denetleyicisi değiliz ve bunları garanti etmiyoruz. Bunları kullanmanız, kendi koşullarına tabidir. Üçüncü taraf içeriğin güvenliği, yasallığı veya davranışından sorumlu değiliz.

## 5. Garanti Yok

Başlatıcı, açık veya örtük hiçbir garanti olmaksızın **"olduğu gibi" ve "mevcut haliyle"** sağlanır; bu, satılabilirlik, belirli bir amaca uygunluk ve ihlal etmeme garantilerini içerir ancak bunlarla sınırlı değildir. Başlatıcı'nın hatasız, güvenli veya her zaman erişilebilir olacağını garanti etmiyoruz.
...
Bu Koşulları zaman zaman güncelleyebiliriz. Üstteki "Son güncelleme" tarihi en son ne zaman değiştirildiklerini gösterir. Değişikliklerden sonra Başlatıcı'yı kullanmaya devam etmeniz, güncellenmiş Koşulları kabul ettiğiniz anlamına gelir.
